...
#define TICKS_COLOR GColorBlack
#define SECONDHAND_COLOR GColorBlack
#define HANDS_COLOR GColorWhite
#define DOT_COLOR GColorBlack
...
// Define a vertical text alignment enum as a new type
